...
/**
 * Chechsum class to manage files integrity
 */
class Checksum {
     ...
     * @param mixed $file
     * @return bool|string false if error, return the hash otherwise
     */
    ...
    /**
     * Check if a file has a checksum
     * @param string $filename the main path (not in the checksum folder) of the file
     * @return bool true if has a checksum
     */
    ...
    /**
     * Add the checksum of a file in the checksum folder
     * @param mixed $file main file path
     * @param string $name name you want to save the checksum file
     * @throws ErrorException
     * @return bool|int
     */
